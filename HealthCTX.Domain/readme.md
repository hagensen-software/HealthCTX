...
| ---------------- | ----------------- | ------------- |
| Bundle           | IBundle           | R4, R5, R6    |
| Encounter        | IEncounter        | R4, R5, R6    |
| Location         | ILocation         | R4, R5, R6    |
| Observation      | IObservation      | R4, R5, R6    |
| OperationOutcome | IOperationOutcome | R4, R5, R6    |
| Organization     | IOrganization     | R4, R5, R6    |
| Patient          | IPatient          | R4, R5, R6    |
| Person           | IPerson           | R4, R5, R6    |
| Practitioner     | IPractitioner     | R4, R5, R6    |
| PractitionerRole | IPractitionerRole | R4, R5, R6    |
