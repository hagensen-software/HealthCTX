...
/// <summary>
/// <para>Interface for HL7 FHIR Observation component.value[CodeableConcept].</para>
...
/// </summary>
public interface IObservationComponentValueCodeableConcept : ICodeableConcept;
