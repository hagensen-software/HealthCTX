...
using HealthCTX.Domain.Test.Encounter.EncounterParticipantR4;
...
public class Test
{
    ...
    public void Encounter_ToFhirJsonGeneratesJsonString()
    {
        var encounter = new Encounter(
            ...
            [new EncounterParticipant(
                ...
                new ParticipantActor(
                    new ActorReference("Practitioner/123")))]);
        ...
        var actor = participant.GetProperty("actor")
        ...
        Assert.Equal("Practitioner/123", actor.GetString());
    }
    ...
    public void Encounter_FromFhirJsonGeneratesRecords()
    {
        ...
        Assert.Equal("Practitioner/123", encounter?.Participants.First().Actor.Reference?.Value);
    }
}
