...
public class Test
{
    ...
    public void Observation_ToFhirJsonGeneratesJsonString()
    {
        var observation = new Observation(
            ...
            new ObservationEffectivePeriod(
        ...
        var effectivePeriod = root.GetProperty("effectivePeriod");
    ...
    public void Observation_FromFhirJsonGeneratesRecords()
    {
        ...
        Assert.Equal(periodStartDate, observation?.Effective.Start?.Value);
        Assert.Equal(periodEndDate, observation?.Effective.End?.Value);
    }
}
