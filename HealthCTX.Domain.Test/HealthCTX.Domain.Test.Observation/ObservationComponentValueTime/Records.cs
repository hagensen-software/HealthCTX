...
namespace HealthCTX.Domain.Test.Observation.ObservationComponentValueTime;
...
public record ValueTime(TimeOnly Value) : IObservationComponentValueTime;

public record ObservationComponent(ObservationComponentCode Code, ValueTime Value) : IObservationComponent;
