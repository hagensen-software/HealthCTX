...
public record ObservationIssued(DateTimeOffset Value) : IObservationIssued;


public record Observation(Status Status, ObservationCode Code, ObservationIssued Issued) : IObservation;
