...
public class Test
{
    ...
    public void Observation_ToFhirJsonGeneratesJsonString()
    {
        ...
        var value = root.GetProperty("valueString");

        Assert.Equal("SomeString", value.GetString());
    }
    ...
    public void Observation_FromFhirJsonGeneratesRecords()
    {
        ...
        Assert.Equal("SomeString", observation?.Value.Value);
    }
}
