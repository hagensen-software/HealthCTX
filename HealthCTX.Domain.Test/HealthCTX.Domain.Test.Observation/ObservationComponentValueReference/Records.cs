...
namespace HealthCTX.Domain.Test.Observation.ObservationComponentValueReference;
...
public record MolecularSequenceReference(string Value) : IReferenceReference;
public record ValueReference(MolecularSequenceReference Reference) : IObservationComponentValueReference;

public record ObservationComponent(ObservationComponentCode Code, ValueReference Value) : IObservationComponent;
