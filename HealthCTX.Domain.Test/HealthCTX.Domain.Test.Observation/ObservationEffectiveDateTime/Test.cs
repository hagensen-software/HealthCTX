...
public class Test
{
    ...
    public void Observation_ToFhirJsonGeneratesJsonString()
    {
        var observation = new Observation(
            ...
            new ObservationEffectiveDateTime(testDate));
        ...
        var effective = root.GetProperty("effectiveDateTime");
    ...
    public void Observation_FromFhirJsonGeneratesRecords()
    {
        var jsonString = $$"""
            {
                ...
                "effectiveDateTime" : "{{testDateString}}"
            }
            """;
        ...
        Assert.Equal(testDate, observation?.Effective?.Value);
    }
}
